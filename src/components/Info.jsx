...
const Info = ({ip}) => {
    ...
    <section className=" p-2 dark:text-gray-100 r" id="info" >
        ...
        md:grid-cols-3 sm:grid-cols-3 xl:grid-cols-4">
            <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none">2s</p>
                    <p className="capitalize">Timmer</p>
                </div>
            </div>
            <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
                <div className="flex justify-center p-2 align-middle rounded-lg sm:p-2 dark:bg-teal-accent-400">
            ...
            <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100  hidden xl:flex xl:justify-center">
                <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-teal-accent-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 dark:text-gray-800">
